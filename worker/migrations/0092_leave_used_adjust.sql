...
--
-- `used` is summed from approved leave_requests. When that sum is wrong —
-- leave approved by mistake, or taken on the ground and never applied for —
-- the eligible figure is wrong with it, and there was no way to fix it short
-- of editing somebody's leave history.
--
