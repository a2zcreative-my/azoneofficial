      ...
      <LivePortfolio
        fallback={
          PORTFOLIO_ITEMS.length === 0 ? (
            <section>
              <p>
                We&apos;re preparing our client showcase — real sessions, real
                numbers, published with each brand&apos;s permission. It will
                land here soon.
              </p>
              <p className="mt-4">
            ...
            <section className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              {PORTFOLIO_ITEMS.map((item) => {
                const card = (
                  <article className="border-border group-hover:bg-secondary/40 h-full rounded-xl border p-5 transition-colors">
