      ...
      <Reveal>
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="text-3xl font-semibold tracking-tight text-balance sm:text-4xl">
            Your next customer is already watching a live. Make it yours.
          </h2>
          ...
          <a
            ...
            className="bg-primary text-primary-foreground hover:bg-primary/85 mt-8 inline-flex h-12 items-center rounded-full px-8 text-sm font-medium transition-colors"
          >
            {CTA_LABEL}
          </a>
        </div>
