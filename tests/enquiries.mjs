...
/* ---- 4. the wiring ---- */
{
  ...
  /* the regexes look for the enquiries entries wherever they sit in the list */
...
else console.log(`PASS — an enquiry is work: overdue after a day, one person's, announced once to those who can answer (${passed} checks)`);
