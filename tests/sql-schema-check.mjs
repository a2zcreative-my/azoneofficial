...
const SRC = ["worker/src/index.ts", "worker/src/staff.ts", "worker/src/erp.ts", "worker/src/m2e.ts", "worker/src/webpush.ts", "worker/src/bridge.ts", "worker/src/threads.ts", "worker/src/sales-performance.ts", "worker/src/company-review.ts"]; // Include each extracted API module in schema validation.
