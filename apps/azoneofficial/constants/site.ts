...
export const SITE_CONFIG = {
  ...
  description:
    "AZ ONE OFFICIAL is a Malaysian live commerce agency. We build and run live selling channels on TikTok Live and Shopee Live — strategy, hosts, operations, creative, and performance marketing — for brands including ELFIA.",
  url: "https://azoneofficial.com",
  locale: "en_MY",
  /** Featured client, referenced in hero copy. */
