...
import { Button, ButtonGroup, FaqList, PageShell, ScrollCarousel } from "@azone/ui";

import { FAQS, PACKAGES, PACKAGE_MATRIX, whatsappUrl } from "@/constants/content";
  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <FaqList items={FAQS} limit={6} offset={5} />
      </section>
