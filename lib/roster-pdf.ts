 ...
 * colours match every other AZ ONE document.
 */
...
export function drawRosterGrid(
  ...
  c.text("AZ ONE OFFICIAL", FM + FW / 2, y + 10, 12, { bold: true, align: "c", spacing: 0.4 });
  ...
  c.wrap(`AZ ONE OFFICIAL - SSM 202603168673 (JM1046169-H) - 34-02, Jalan Setia Tropika 1/1, Taman Setia Tropika, 81200 Johor Bahru, Johor - Generated by ${generatedBy} on ${stamp}. Hosts are notified in the staff portal; this PDF is a snapshot for awareness - the in-system roster is authoritative.`,
...
export async function shareRosterPdf(
  ...
  const blob = new Blob(
    [assemblePdf(drawRosterGrid(days, sessions, staff, onLeave, conflictIds, generatedBy), [], `AZ ONE Roster ${weekTag}`, true) as BlobPart],
